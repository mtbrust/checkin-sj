...
class BdLogins extends DataBase
{
    ...
    public function createTable($fields = null)
    {
        ...
        $fields = [
            ...
            // Controle
            "initialUrl" => "VARCHAR(255) NULL",   // Redireciona para esta URL após logado. (Personalização)
            "menu"       => "MEDIUMTEXT NULL",     // Menu Personalizado serialize.
